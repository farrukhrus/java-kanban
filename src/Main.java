...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // ========== Задачи ========== //
        // создание задачи
        Task task1 = new Task("task1", "task1_before", Status.NEW, Duration.ofSeconds(14), LocalDateTime.of(2024, 8, 19, 20, 9, 25));
        tm.addTask(task1);

        Task task3 = new Task("task3", "task3 comment", Status.NEW, Duration.ofSeconds(14), LocalDateTime.of(2024, 8, 19, 21, 9, 25));
        tm.addTask(task3);

        Task task4 = new Task("task4", "task4 comment", Status.NEW, Duration.ofSeconds(14), LocalDateTime.of(2024, 8, 19, 22, 9, 25));
        tm.addTask(task4);
        ...
        // ========== Эпики ========== //
        // создание эпика
        Epic e1 = new Epic("epic1", "epic1_before", Status.NEW, Duration.ofSeconds(5000), LocalDateTime.of(2024, 8, 19, 20, 15, 15));
        tm.addEpic(e1);
        // обновление эпика
        Epic e2 = new Epic("epic1", "epic1_after", Status.NEW, Duration.ofSeconds(5000), LocalDateTime.of(2024, 8, 19, 20, 15, 45));
        e2.setId(e1.getId());
        tm.updateEpic(e2);

        // ========== Подзадачи ========== //
        SubTask t1 = new SubTask("subtask1", "subtask1_before", Status.NEW, e1.getId(), LocalDateTime.of(2024, 8, 19, 20, 15, 45), Duration.ofSeconds(50));
        SubTask t3 = new SubTask("subtask3", "subtask3_before", Status.NEW, e1.getId(), LocalDateTime.of(2024, 8, 19, 20, 19, 45), Duration.ofSeconds(50));
